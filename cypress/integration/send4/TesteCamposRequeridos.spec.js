...
const comentario = 'Teste executado de devolução'
 ...
 //teste 1
 describe('Acessar a pagina Send4 validar troca/devolução - Loja Física - Campos requeridos', () => {
    it('Acessa a pagina e cadastrar troca/devolução - Loja Física - Campos requeridos',() => {
        cy.visit(testUrl)


      //*[@id="root"]/section/main/div[2]/div[1]/div/form/div[1]/div/div[1]/div[2]/span
        ...
        cy.xpath('//*[@id="root"]/section/main/div[2]/div[1]/div/form/div[1]/div/div[1]/div[1]/span').should('have.text', 'Preencha este campo.')
        cy.get('#customer__continue').click()
        ...
        cy.get('#customer__continue').click()
        cy.xpath('//*[@id="root"]/section/main/div[2]/div[1]/div/form/div[1]/div/div[1]/div[2]/span').should('have.text', 'Preencha este campo.')
        cy.get('#customer__continue').click()
        ...
        cy.get('#customer__continue').click()
        cy.xpath('//*[@id="root"]/section/main/div[2]/div[1]/div/form/div[1]/div/div[1]/div[3]/span').should('have.text', 'Preencha este campo.')
        cy.get('#customer__continue').click()
        ...
        cy.get('#customer__continue').click()
        cy.xpath('//*[@id="root"]/section/main/div[2]/div[1]/div/form/div[1]/div/div[2]/div[1]/span').should('have.text', 'Preencha este campo.')
        cy.get('#customer__continue').click()
        ...
        cy.get('#customer__continue').click()
        cy.xpath('//*[@id="root"]/section/main/div[2]/div[1]/div/form/div[1]/div/div[2]/div[2]/span').should('have.text', 'Preencha este campo.')
        cy.get('#customer__continue').click()
        ...
        cy.xpath('//*[@id="root"]/section/main/div[2]/div[1]/div/form/div[2]/div/div[1]/div[1]/span').should('have.text', 'Preencha este campo.')
        cy.get('#customer__continue').click()
        ...
        cy.xpath('//*[@id="root"]/section/main/div[2]/div[1]/div/form/div[2]/div/div[1]/div[3]/span').should('have.text', 'Preencha este campo.')
        cy.get('#customer__continue').click()
        ...
        cy.xpath('//*[@id="root"]/section/main/div[2]/div[1]/form/div[1]/div[1]/div/div[1]/span').should('have.text', 'Preencha este campo.')
        ...
        cy.xpath('//*[@id="root"]/section/main/div[2]/div[1]/form/div[1]/div[1]/div/div[2]/div/span').should('have.text', 'Preencha este campo.')
        ...
        cy.xpath('//*[@id="root"]/section/main/div[2]/div[1]/form/div[1]/div[1]/div/div[4]/span').should('have.text', 'Preencha este campo.')
        ...
        cy.xpath('//*[@id="root"]/section/main/div[2]/div[1]/div[1]/form/div[1]/div[1]/span').should('have.text', 'Preencha este campo.')
        ...
        cy.xpath('//*[@id="root"]/section/main/div[2]/div[1]/div[1]/form/div[1]/div[3]/span').should('have.text', 'Preencha este campo.')

        cy.get('#product-value').type(produtoPreco)

        cy.xpath('//*[@id="root"]/section/main/div[2]/div[1]/div[1]/form/div[2]/div[1]/span').should('have.text', 'Selecione um item da lista.')

         cy.xpath('/html/body/div[1]/section/main/div[2]/div[1]/div[1]/form/div[2]/div[1]/select').select(acao)

         cy.get('.btn > span').click()

         cy.xpath('//*[@id="root"]/section/main/div[2]/div[1]/div[1]/form/div[2]/div[2]/span').should('have.text', 'Selecione um item da lista.')
        ...
        /**
         * Teste realizado até aqui para validação dos campos reqeridos
         */
