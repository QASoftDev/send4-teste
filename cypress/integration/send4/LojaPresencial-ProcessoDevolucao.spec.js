...
const acao = 'Devolver'
const motivoTamanhoErrado = 'Tamanho errado'
const motivoMeArrependi = 'Me arrependi'
const comentario = 'Teste executado de devolução'



 //teste 1
 describe('Acessar a pagina Send4 validar devolver, tamanho errado - Loja Física', () => {
    it('Acessa a pagina e cadastrar devolver, tamanho errado',() => {
        cy.visit(testUrl)
       ...
       //cy.get('#address-complement').type(complemento)
       ...
       cy.get('#seller-invoice-upload').uploadFile(caminhoImageNF);
       ...
       cy.xpath('/html/body/div[1]/section/main/div[2]/div[1]/div[1]/form/div[2]/div[2]/select').select(motivoTamanhoErrado)
       ...
       cy.get('[data-title="Motivos"]').should('have.text',motivoTamanhoErrado)
 ...
 //teste 2
 describe('Acessar a pagina Send4 validar devolver, me arrependi  - Loja Física', () => {
    it('Acessa a pagina e cadastrar devolver,me arrependi ',() => {
        cy.visit(testUrl)
       ...
       cy.get('#product-value').type(produtoPreco)
       cy.xpath('/html/body/div[1]/section/main/div[2]/div[1]/div[1]/form/div[2]/div[1]/select').select(acao)
       cy.xpath('/html/body/div[1]/section/main/div[2]/div[1]/div[1]/form/div[2]/div[2]/select').select(motivoMeArrependi)
       cy.xpath('/html/body/div[1]/section/main/div[2]/div[1]/div[1]/form/div[3]/div/textarea').type(comentario)
       cy.get('.btn > span').click()
       ...
       cy.get('[data-title="Valor"]').should('have.text','R$ 25,00')
       cy.get('[data-title="Ação"]').should('have.text',acao)
       cy.get('[data-title="Motivos"]').should('have.text',motivoMeArrependi)
       cy.get('[data-title="Comentário"]').should('have.text',comentario)
